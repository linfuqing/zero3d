...
public:
	...
	virtual INT IsGameOver(BOARD<TYPE, WIDTH, HEIGHT>& Board, const UINT uDepth, const SEARCHSIDE Side, const BOOL bIsCurrentSide) = 0;
...
template<typename TYPE, UINT WIDTH, UINT HEIGHT>
INT CEveluation<TYPE, WIDTH, HEIGHT>::IsGameOver(BOARD<TYPE, WIDTH, HEIGHT> &Board, const INT uDepth, const SEARCHSIDE Side, const BOOL bIsCurrentSide)
{
	INT i, j;
