package AlchemyLib.base
{
	...
	public class Library extends Sprite
	{
		...
		public static function get alchemy3DLib():Object
		{
			if(_instance == null)
				_instance = new Library();
			
			return _alchemy3DLib;
		}
...
//							dest[i] = Library.memory.readUTFBytes();
		...
		public function Library()
		{
			...
			if(!_memory || !_alchemy3DLib)
			{
				var clib:CLibInit = new CLibInit();
				_alchemy3DLib = clib.init();
		...
		private static var _alchemy3DLib:Object = null;
	}
}