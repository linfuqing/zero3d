...
package zerO.materials.particle
{
	 ...
	 */
	public class ParticlePiexsMaterial extends ParticleMaterial implements IParticleMaterial, IBitmapViewportMaterial
	{
		/**
		 * 亮度.
		 */
		 ...
		 * 构建新的火花.
		 */
		public function ParticlePiexsMaterial( color:uint = 0xff000000,lightness:Number = 5 )
		{
			super();
			this.color = color;
