...
package zerO.physics.controllers
{
	...
	public class ForceController extends NameSetter implements IController
	{
		 ...
		 * 力反弹,离界越远力越大.
		 */
		public function boundaryDetection( border:Bounds ):void
		{
		 ...
		 * 界限反弹,粒子不会不超过界.
		 */
		public function boundaryBounce( border:Bounds,bounce:Number ):void
		{
		...
		public function update():void
		{
			...
			target.position = target.position.add( velocity );
		}
