...
//不带纹理光栅化
#define RENDER_FLAT_TRIANGLE_32								0x000020	//32位Flat模式不带Z缓冲
#define RENDER_FLAT_TRIANGLEFP_32							0x000040	//32位Flat定点模式不带Z缓冲
#define RENDER_FLAT_TRIANGLE_INVZB_32						0x000080	//32位模式 + 1/z深度缓冲 + Flat光照模型
#define RENDER_GOURAUD_TRIANGLE_INVZB_32					0x000100	//32位模式 + 1/z深度缓冲 + Gouraud光照模型

//带alpha光栅化
#define RENDER_TEXTRUED_TRIANGLE_FSINVZB_ALPHA_32			0x000200	//32位模式 + 1/z深度缓冲 + Flat光照模型 + 纹理映射
#define RENDER_TEXTRUED_TRIANGLE_GSINVZB_ALPHA_32			0x000400	//32位模式 + 1/z深度缓冲 + Gouraud光照模型 + 纹理映射

#define RENDER_TEXTRUED_TRIANGLE_FOG_INVZB_ALPHA_32         0x001000
#define RENDER_TRIANGLE_FOG_FSINVZB_ALPHA_32                0x002000
#define RENDER_TRIANGLE_FOG_GSINVZB_ALPHA_32                0x004000
#define RENDER_TEXTRUED_TRIANGLE_FOG_FSINVZB_ALPHA_32       0x008000
#define RENDER_TEXTRUED_TRIANGLE_FOG_GSINVZB_ALPHA_32		0x010000	//32位模式 + 1/z深度缓冲 + Gouraud光照模型 + 纹理映射 + 雾化效果

#define RENDER_TRIANGLE_FSINVZB_ALPHA_32					0x020000
#define RENDER_TRIANGLE_GSINVZB_ALPHA_32					0x040000
#define RENDER_TEXTRUED_TRIANGLE_INVZB_ALPHA_32         	0x080000

#define RENDER_MODE_CONTAIN_ALPHA(x) (x > 0x100)
