package
{
	...
	public class Test8X extends Basic
	{
		...
		protected function init(e:Event):void
		{
			...
			t0 = new Texture(null, bl.getBitmapData("2"));
			t1 = new Texture(null, bl.getBitmapData("1"));
			t2 = new Texture(null, bl.getBitmapData("4"));
			...
			var fog:Fog = new Fog(new ColorTransform(1, 1, 1, 1), 800, 2500, 1, Fog.FOG_LINEAR);
			scene.addFog(fog);
...
//			md2.scale = 2;
			...
			center.terrainTrace = Entity.TERRAIN_TRACE_FIXED_HEIGHT;
			viewport.scene.addChild(center);
			
			water = new Primitives(m3, t2, RenderMode.RENDER_TEXTRUED_TRIANGLE_INVZB_ALPHA_32);
			...
			terrain = new MeshTerrain(null, m2, t1, RenderMode.RENDER_TEXTRUED_TRIANGLE_FOG_GSINVZB_ALPHA_32);
			terrain.buildOn(40000, 40000, 50000);
			terrain.mesh.lightEnable = true;
			terrain.mesh.octreeDepth = 3;
			terrain.mesh.texScaleX = 50;
			terrain.mesh.texScaleY = 50;
		...
		protected function onKeyDown(e:KeyboardEvent):void
		{
			...
			if ( e.keyCode == 84 )
			{
				...
				else
				{
					...
					terrain.mesh.setAttribute(Mesh3D.TEXTURE_KEY, t1);
				}
			...
			if ( e.keyCode == 82 )
			{
				...
				if (_renderModeState == 1)
				{
					...
					terrain.mesh.setAttribute(Mesh3D.RENDERMODE_KEY, RenderMode.RENDER_TEXTRUED_TRIANGLE_FOG_GSINVZB_ALPHA_32);
				}
